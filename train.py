...
def init(args):
    ...
    print(f"[DEBUG] Total batch size = {sup_hyper['train_batch_size']} × {torch.cuda.device_count()} × {sup_hyper['grad_accumulation']}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_path', type=str, default='config')
    ...
    lambda ex: ex['train_task'] == 'instruction_gen_visualcues' or len(ex['label_imgs']) > 0
    )
    ...
    from scripts.trainer.customize_trainer import CustomizeSeq2SeqTrainer
