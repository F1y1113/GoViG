...
def customize_data_collator(features: List[InputDataClass]) -> Dict[str, Any]:
    ...
    # print(f"DEBUG: features[0] type: {type(features[0]) if features else 'Empty list'}")
    # print(f"DEBUG: features[0] content: {features[0] if features else 'Empty list'}")
    ...
    # print(f"DEBUG: After filtering, features[0] type: {type(features[0])}")
    # print(f"DEBUG: After filtering, features[0] content: {features[0]}")
    ...
    first = features[0]
    # print(f"DEBUG: first variable type: {type(first)}")
    # print(f"DEBUG: first variable content: {first}")
