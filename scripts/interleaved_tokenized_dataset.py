...
class InterleaveAnoleTokenizedDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if item.get("train_task") == "task_level_evaluation":
            return item
    ...
    def _register_bin_tokens(self):
        ...
        existing_vocab = set(self.processor.tokenizer.get_vocab().keys())
        ...
        if new_tokens:
            ...
            self.label_processor.tokenizer.add_tokens(new_tokens, special_tokens=True)